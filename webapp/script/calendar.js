...
function calendar_set(e)
{
    ...
    calendar_div.style.cssText = "width:160px; padding:5px; background-color:#ffffff; border:1px solid #666666;z-index:1000";
...
function calendar_draw(set_date)
{
    ...
    // 년, 월, 닫기 버튼 html
    html += "<tr height=\"20\">";
    html += "<td colspan=\"6\" width=\"100%\" align=\"center\" valign=\"center;\" style=\"color:#444444;\">";
    html += "<span style=\"cursor:pointer; font: 10px dotum;\" onClick=\"calendar_draw('"+prev_y+"')\">◀</span>&nbsp;";
    html += "<span style=\"cursor:pointer; font: 10px verdana;font-weight:bold;\" onClick=\"calendar_years_toggle()\">↕ "+calendar_y+"</span>&nbsp;";
    html += "<span style=\"cursor:pointer; font: 10px dotum;\" onClick=\"calendar_draw('"+next_y+"')\">▶</span>&nbsp;";
    html += "<span style=\"cursor:pointer; font: 10px dotum;\" onClick=\"calendar_draw('"+prev_m+"')\">◀</span>&nbsp;";
    html += "<span style=\"cursor:pointer; font: 10px verdana;font-weight:bold;\" onClick=\"calendar_months_toggle()\">↕ "+calendar_m+"</span>&nbsp;";
    html += "<span style=\"cursor:pointer; font: 10px dotum;\" onClick=\"calendar_draw('"+next_m+"')\">▶</span>&nbsp;";
    html += "</td>";
    html += "<td align=\"right\" valign=\"center;\" style=\"color:#444444;\"><span style=\"cursor:pointer; font: 10px dotum; font-weight:bold;\" onClick=\"calendar_close()\">X</span></td>";
    html += "</tr>";
    // 요일표시 html
    html += "<tr height=\"20\">";
    html += "<td width=\"16%\" style=\"color:#333; text-align:center; font:bold 11px dotum;\">일</td>";
    html += "<td width=\"14%\" style=\"color:#333; text-align:center; font:bold 11px dotum;\">월</td>";
    html += "<td width=\"14%\" style=\"color:#333; text-align:center; font:bold 11px dotum;\">화</td>";
    html += "<td width=\"14%\" style=\"color:#333; text-align:center; font:bold 11px dotum;\">수</td>";
    html += "<td width=\"14%\" style=\"color:#333; text-align:center; font:bold 11px dotum;\">목</td>";
    html += "<td width=\"14%\" style=\"color:#333; text-align:center; font:bold 11px dotum;\">금</td>";
    html += "<td width=\"14%\" style=\"color:#333; text-align:center; font:bold 11px dotum;\">토</td>";
    html += "</tr>";
    ...
    for(var i=1; i<=max_days; i++)
    {
        ...
        style = "cursor:pointer; font:10px verdana; text-align:center;";
        ...
        if(week == 6)
            style += " color:0099cc;";
        html += "<td style=\""+style+"\" onClick=\"calendar_set_date('"+this_date+"');\" onMouseOver=\"this.style.backgroundColor = '#ffd6da';\" onMouseOut=\"this.style.backgroundColor = '#ffffff';\">"+i+"</td>";
        week ++;
    }
