...
<jpdk_query>
   <query_list>
      ...
      <query id="community.user.insert">
         <sql><![CDATA[
         INSERT INTO LF_USER (USER_ID, USER_PASSWORD, USER_NICKNAME, USER_NAME, USER_PHONE, USER_STATE, USER_TYPE, USER_LEVEL, USER_CREATED)
              VALUES ([USER_ID], PASSWORD([USER_PW]), [USER_NICK], [USER_NAME], [USER_PHONE], [USER_STATE], [USER_TYPE], [USER_LEVEL], SYSDATE())
          ]]></sql>
      </query>
      
      <query id="community.user.one.select">
         <sql><![CDATA[
         SELECT USER_ID, USER_PASSWORD, USER_NICKNAME, USER_NAME, USER_PHONE, USER_STATE, USER_TYPE, USER_LEVEL
           FROM LF_USER
          WHERE USER_ID = [USER_ID]
            AND USER_PASSWORD = PASSWORD([USER_PW])
          ]]></sql>
      </query>
      
      <query id="community.user.list.select">
         <sql><![CDATA[
         SELECT USER_ID, USER_PASSWORD, USER_NICKNAME, USER_NAME, USER_PHONE, USER_STATE, USER_TYPE, USER_LEVEL
           FROM LF_USER
      ...
      <query id="community.user.update">
         <sql><![CDATA[
         UPDATE LF_USER
      ...
      <query id="community.user.grade.list.select">
         <sql><![CDATA[
